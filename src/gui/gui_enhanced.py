...
class EnhancedChatDebugGUI:
    ...
    def create_debug_area(self, parent):
        ...
        # 创建独立的日程管理GUI
        try:
            from src.gui.schedule_gui import ScheduleManagerGUI
            # 获取数据库管理器实例
            if hasattr(self, 'agent') and self.agent and hasattr(self.agent, 'db'):
    ...
    def refresh_event_list(self):
        ...
        try:
            ...
            # 获取所有事件
            from src.core.event_manager import EventType, EventStatus
...
通知型：{stats['notifications']}  |  任务型：{stats['tasks']}"""
    ...
    def trigger_selected_event(self):
        ...
        from src.core.event_manager import EventStatus
...
{event_dict['description']}"""
        ...
        from src.core.event_manager import EventType
